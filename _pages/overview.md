...
You will need a computer able to run <a href="https://www.virtualbox.org">VirtualBox</a>{:target="_blank"}, which is available for Windows, OSX and Linux.
...
<ul>
 	<li>You can install <a href="https://www.virtualbox.org/manual/ch04.html">Virtualbox Guest Additions</a> and create a shared folder.
Then you copy the data in the directory on your computer and can access it in the virtual machine.&nbsp;</li>
 	<li>You can directly mount a network device in the virtual machine and transfer the data.</li>
 	<li>When you connect the virtual machine to the internet, you can download the data from any webpage.</li>
...
Currently, we provide the piplines in the <a href="{filename}quickstart.md">Quickstart</a>.
<h4>How can I contribute to the Data Arena Virtual Machine?</h4>
The entire software will be available on <a href="https://github.com/UTSDataArena">GitHub</a> soon.
